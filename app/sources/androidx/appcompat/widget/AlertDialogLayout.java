...
public class AlertDialogLayout extends C0229i0 {
    public AlertDialogLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    /* renamed from: A */
    private void m849A(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: B */
    private static int m850B(View view) {
        int z = C1988t.m8419z(view);
        if (z > 0) {
            return z;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m850B(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    /* renamed from: C */
    private boolean m851C(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C1440f.topPanel) {
                    view = childAt;
                } else if (id == C1440f.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C1440f.contentPanel && id != C1440f.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
    ...
    /* renamed from: l */
    private void m852l(int i, int i2) {
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824);
        for (int i3 = 0; i3 < i; i3++) {
            View childAt = getChildAt(i3);
            if (childAt.getVisibility() != 8) {
                C0229i0.C0230a aVar = (C0229i0.C0230a) childAt.getLayoutParams();
                if (aVar.width == -1) {
                    int i4 = aVar.height;
    ...
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L_0x005a:
            ...
            r15 = r2
            androidx.appcompat.widget.i0$a r15 = (androidx.appcompat.widget.C0229i0.C0230a) r15
            int r2 = r15.f1007b
            if (r2 >= 0) goto L_0x007e
            r2 = r11
        L_0x007e:
            int r3 = p027c.p064i.p072j.C1988t.m8417y(r17)
            int r2 = p027c.p064i.p072j.C1915d.m8012b(r2, r3)
            r2 = r2 & 7
            r3 = 1
