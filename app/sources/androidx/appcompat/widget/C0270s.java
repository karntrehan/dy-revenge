...
public class C0270s extends RadioButton implements C1196j, C1987s {

    /* renamed from: f */
    private final C0228i f1183f;

    /* renamed from: o */
    private final C0214e f1184o;

    /* renamed from: p */
    private final C0293y f1185p;

    public C0270s(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1435a.f4186E);
    }

    public C0270s(Context context, AttributeSet attributeSet, int i) {
    ...
    public void drawableStateChanged() {
        ...
        C0214e eVar = this.f1184o;
        if (eVar != null) {
            eVar.mo1318b();
        }
        C0293y yVar = this.f1185p;
        if (yVar != null) {
            yVar.mo1804b();
        }
    }
