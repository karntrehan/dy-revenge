...
/* renamed from: androidx.camera.camera2.e.j3.i0 */
class C0409i0 extends C0415l0 {
    C0409i0(CameraDevice cameraDevice, Object obj) {
        super(cameraDevice, obj);
    }

    /* renamed from: g */
    static C0409i0 m1858g(CameraDevice cameraDevice, Handler handler) {
        return new C0409i0(cameraDevice, new C0415l0.C0416a(handler));
    }
    ...
    public void mo2124a(C0444g gVar) {
        ...
        List<Surface> f = C0415l0.m1866f(gVar.mo2189c());
        ...
        if (b != null) {
            try {
                ...
                this.f1538a.createReprocessableCaptureSession(inputConfiguration, f, cVar, handler);
            } catch (CameraAccessException e) {
                throw C0386a0.m1792e(e);
            }
        } else if (gVar.mo2190d() == 1) {
            this.f1538a.createConstrainedHighSpeedCaptureSession(f, cVar, handler);
        } else {
            mo2137e(this.f1538a, f, cVar, handler);
        }
    }
}
