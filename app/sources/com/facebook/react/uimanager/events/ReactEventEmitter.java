...
public class ReactEventEmitter implements RCTModernEventEmitter {
    ...
    private RCTEventEmitter getEventEmitter(int i) {
        ...
        if (this.mRCTEventEmitter == null) {
            if (this.mReactContext.hasActiveReactInstance()) {
                ...
                ReactSoftExceptionLogger.logSoftException(TAG, new ReactNoCrashSoftException("Cannot get RCTEventEmitter from Context for reactTag: " + i + " - uiManagerType: " + a + " - No active Catalyst instance!"));
            }
        }
    ...
    public void receiveEvent(int i, int i2, String str, boolean z, int i3, WritableMap writableMap, int i4) {
        ...
        int i5 = i2;
        String str2 = str;
        int a = C2996a.m11878a(i2);
        if (a == 2 && (rCTModernEventEmitter = this.mFabricEventEmitter) != null) {
            rCTModernEventEmitter.receiveEvent(i, i2, str, z, i3, writableMap, i4);
        } else if (a != 1 || getEventEmitter(i2) == null) {
    ...
    public void receiveTouches(String str, WritableArray writableArray, WritableArray writableArray2) {
        RCTModernEventEmitter rCTModernEventEmitter;
        C6409a.m24519a(writableArray.size() > 0);
        int i = writableArray.getMap(0).getInt("target");
        int a = C2996a.m11878a(i);
        if (a == 2 && (rCTModernEventEmitter = this.mFabricEventEmitter) != null) {
            rCTModernEventEmitter.receiveTouches(str, writableArray, writableArray2);
        } else if (a != 1 || getEventEmitter(i) == null) {
            ReactSoftExceptionLogger.logSoftException(TAG, new ReactNoCrashSoftException("Cannot find EventEmitter for receivedTouches: ReactTag[" + i + "] UIManagerType[" + a + "] EventName[" + str + "]"));
        } else {
