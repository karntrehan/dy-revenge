...
@C2639a(name = "IntentAndroid")
public class IntentModule extends NativeIntentAndroidSpec {
    public static final String NAME = "IntentAndroid";

    /* renamed from: com.facebook.react.modules.intent.IntentModule$a */
    static /* synthetic */ class C2827a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f7985a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f7985a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.modules.intent.IntentModule.C2827a.<clinit>():void");
        }
    }
    ...
    public void sendIntent(String str, ReadableArray readableArray, Promise promise) {
        ...
        if (readableArray != null) {
            for (int i = 0; i < readableArray.size(); i++) {
                ...
                int i2 = C2827a.f7985a[map.getType(nextKey).ordinal()];
                if (i2 == 1) {
