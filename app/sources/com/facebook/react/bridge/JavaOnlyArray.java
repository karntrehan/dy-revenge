...
public class JavaOnlyArray implements ReadableArray, WritableArray {
    ...
    static /* synthetic */ class C26661 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.react.bridge.JavaOnlyArray.C26661.<clinit>():void");
        }
    }
    ...
    public static JavaOnlyArray deepClone(ReadableArray readableArray) {
        ...
        for (int i = 0; i < size; i++) {
            switch (C26661.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i).ordinal()]) {
                case 1:
    ...
    /* renamed from: of */
    public static JavaOnlyArray m10885of(Object... objArr) {
