...
public class ColorPropConverter {
    ...
    private static int resolveResource(Context context, String str) {
        ...
        return C1154f.m4490c(context.getResources(), context.getResources().getIdentifier(split2[1], str2, packageName), context.getTheme());
    }

    private static int resolveThemeAttribute(Context context, String str) {
        String replaceAll = str.replaceAll(ATTR_SEGMENT, HttpUrl.FRAGMENT_ENCODE_SET);
