...
public class TurboModuleManager implements JSIModule, TurboModuleRegistry {
    ...
    public TurboModuleManager(RuntimeExecutor runtimeExecutor, final TurboModuleManagerDelegate turboModuleManagerDelegate, CallInvokerHolder callInvokerHolder, CallInvokerHolder callInvokerHolder2) {
        maybeLoadSoLibrary();
        this.mHybridData = initHybrid(runtimeExecutor, (CallInvokerHolderImpl) callInvokerHolder, (CallInvokerHolderImpl) callInvokerHolder2, turboModuleManagerDelegate, C3257a.f9222c, C3257a.f9223d);
        installJSIBindings();
        ...
        this.mCxxModuleProvider = new TurboModuleProvider() {
            public TurboModule getModule(String str) {
                ...
                C6409a.m24520b(legacyCxxModule instanceof TurboModule, "CxxModuleWrapper \"" + str + "\" is not a TurboModule");
    ...
    public com.facebook.react.turbomodule.core.interfaces.TurboModule getModule(java.lang.String r4) {
        /*
            ...
            monitor-enter(r0)
            boolean r1 = r3.mTurboModuleCleanupStarted     // Catch:{ all -> 0x003f }
            if (r1 == 0) goto L_0x000a
            r4 = 0
            monitor-exit(r0)     // Catch:{ all -> 0x003f }
            return r4
        L_0x000a:
            java.util.Map<java.lang.String, com.facebook.react.turbomodule.core.TurboModuleManager$TurboModuleHolder> r1 = r3.mTurboModuleHolders     // Catch:{ all -> 0x003f }
            boolean r1 = r1.containsKey(r4)     // Catch:{ all -> 0x003f }
            if (r1 != 0) goto L_0x001c
            java.util.Map<java.lang.String, com.facebook.react.turbomodule.core.TurboModuleManager$TurboModuleHolder> r1 = r3.mTurboModuleHolders     // Catch:{ all -> 0x003f }
            com.facebook.react.turbomodule.core.TurboModuleManager$TurboModuleHolder r2 = new com.facebook.react.turbomodule.core.TurboModuleManager$TurboModuleHolder     // Catch:{ all -> 0x003f }
            r2.<init>()     // Catch:{ all -> 0x003f }
            r1.put(r4, r2)     // Catch:{ all -> 0x003f }
        L_0x001c:
            java.util.Map<java.lang.String, com.facebook.react.turbomodule.core.TurboModuleManager$TurboModuleHolder> r1 = r3.mTurboModuleHolders     // Catch:{ all -> 0x003f }
            java.lang.Object r1 = r1.get(r4)     // Catch:{ all -> 0x003f }
            com.facebook.react.turbomodule.core.TurboModuleManager$TurboModuleHolder r1 = (com.facebook.react.turbomodule.core.TurboModuleManager.TurboModuleHolder) r1     // Catch:{ all -> 0x003f }
            monitor-exit(r0)     // Catch:{ all -> 0x003f }
