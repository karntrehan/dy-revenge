...
public class C4806c implements C4807d {
    ...
    /* renamed from: b */
    private static boolean m18365b(StackTraceElement[] stackTraceElementArr, int i, int i2) {
        int i3 = i2 - i;
    ...
    /* renamed from: c */
    private static StackTraceElement[] m18366c(StackTraceElement[] stackTraceElementArr, int i) {
        int i2;
        ...
        while (i3 < stackTraceElementArr.length) {
            ...
            if (num == null || !m18365b(stackTraceElementArr, num.intValue(), i3)) {
    ...
    public StackTraceElement[] mo14705a(StackTraceElement[] stackTraceElementArr) {
        StackTraceElement[] c = m18366c(stackTraceElementArr, this.f13539a);
