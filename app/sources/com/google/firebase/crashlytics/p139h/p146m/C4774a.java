package com.google.firebase.crashlytics.p139h.p146m;
...
public class C4774a {
    ...
    /* renamed from: b */
    private final Map<String, String> f13451b;

    /* renamed from: c */
    private final Map<String, String> f13452c = new HashMap();

    public C4774a(String str, Map<String, String> map) {
        this.f13450a = str;
        this.f13451b = map;
    }
    ...
    private java.lang.String m18240a(java.util.Map<java.lang.String, java.lang.String> r7) {
        /*
            r6 = this;
        ...
        L_0x0069:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.crashlytics.p139h.p146m.C4774a.m18240a(java.util.Map):java.lang.String");
    }

    /* renamed from: b */
    private String m18241b(String str, Map<String, String> map) {
        String a = m18240a(map);
        if (a.isEmpty()) {
            return str;
        }
        if (str.contains("?")) {
    ...
    /* renamed from: e */
    private String m18242e(InputStream inputStream) {
    ...
    /* renamed from: c */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public com.google.firebase.crashlytics.p139h.p146m.C4776c mo14653c() {
        /*
            r5 = this;
            r0 = 0
            java.lang.String r1 = r5.f13450a     // Catch:{ all -> 0x0084 }
            java.util.Map<java.lang.String, java.lang.String> r2 = r5.f13451b     // Catch:{ all -> 0x0084 }
            java.lang.String r1 = r5.m18241b(r1, r2)     // Catch:{ all -> 0x0084 }
            com.google.firebase.crashlytics.h.f r2 = com.google.firebase.crashlytics.p139h.C4542f.m17259f()     // Catch:{ all -> 0x0084 }
            ...
            r2.mo14110i(r3)     // Catch:{ all -> 0x0084 }
            ...
            java.util.Map<java.lang.String, java.lang.String> r2 = r5.f13452c     // Catch:{ all -> 0x0082 }
        ...
        L_0x005f:
            ...
            java.lang.String r0 = r5.m18242e(r3)     // Catch:{ all -> 0x0071 }
            goto L_0x0074
        L_0x0071:
            r2 = move-exception
            r0 = r3
        ...
        L_0x0079:
            r1.disconnect()
            com.google.firebase.crashlytics.h.m.c r1 = new com.google.firebase.crashlytics.h.m.c
            r1.<init>(r2, r0)
            return r1
        L_0x0082:
            r2 = move-exception
        ...
        L_0x0090:
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.crashlytics.p139h.p146m.C4774a.mo14653c():com.google.firebase.crashlytics.h.m.c");
    }

    /* renamed from: d */
    public C4774a mo14654d(String str, String str2) {
        this.f13452c.put(str, str2);
        return this;
    }
}
