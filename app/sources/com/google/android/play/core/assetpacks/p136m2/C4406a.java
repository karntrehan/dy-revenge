package com.google.android.play.core.assetpacks.p136m2;

import java.util.HashMap;
import java.util.Map;
import okhttp3.HttpUrl;

/* renamed from: com.google.android.play.core.assetpacks.m2.a */
public final class C4406a {

    /* renamed from: a */
    private static final Map<Integer, String> f12575a;

    /* renamed from: b */
    private static final Map<Integer, String> f12576b;
    ...
    /* renamed from: a */
    public static String m16888a(int i) {
        Map<Integer, String> map = f12575a;
        Integer valueOf = Integer.valueOf(i);
        if (!map.containsKey(valueOf)) {
            return HttpUrl.FRAGMENT_ENCODE_SET;
        }
        String str = map.get(valueOf);
        String str2 = f12576b.get(valueOf);
