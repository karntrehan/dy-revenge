package com.google.android.play.core.install.p137d;

import java.util.HashMap;
import java.util.Map;
import okhttp3.HttpUrl;

/* renamed from: com.google.android.play.core.install.d.a */
public final class C4464a {

    /* renamed from: a */
    private static final Map<Integer, String> f12745a;

    /* renamed from: b */
    private static final Map<Integer, String> f12746b;
    ...
    /* renamed from: a */
    public static String m17051a(int i) {
        Map<Integer, String> map = f12745a;
        Integer valueOf = Integer.valueOf(i);
        if (!map.containsKey(valueOf)) {
            return HttpUrl.FRAGMENT_ENCODE_SET;
        }
        Map<Integer, String> map2 = f12746b;
