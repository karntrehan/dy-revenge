...
public final class C4038s3 extends C3876f4 {

    /* renamed from: c */
    private final C4026r3 f11262c;

    /* renamed from: d */
    private boolean f11263d;

    C4038s3(C3955l5 l5Var) {
        super(l5Var);
        Context f = this.f10651a.mo11938f();
        this.f10651a.mo12181z();
        this.f11262c = new C4026r3(this, f, "google_app_measurement_local.db");
    }
    ...
    private final boolean m15314x(int r17, byte[] r18) {
        /*
            r16 = this;
            r1 = r16
            r16.mo11931h()
            boolean r0 = r1.f11263d
            r2 = 0
        ...
        L_0x0028:
            ...
            r7 = 1
            r8 = 0
            android.database.sqlite.SQLiteDatabase r9 = r16.mo12405o()     // Catch:{ SQLiteFullException -> 0x00fb, SQLiteDatabaseLockedException -> 0x00e9, SQLiteException -> 0x00c2, all -> 0x00bf }
            if (r9 != 0) goto L_0x0035
            r1.f11263d = r7     // Catch:{ SQLiteFullException -> 0x00bb, SQLiteDatabaseLockedException -> 0x00ea, SQLiteException -> 0x00b7 }
            return r2
        L_0x0035:
        ...
        L_0x0054:
            ...
            com.google.android.gms.measurement.internal.l5 r15 = r1.f10651a     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            com.google.android.gms.measurement.internal.z3 r15 = r15.mo11935b()     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            com.google.android.gms.measurement.internal.x3 r15 = r15.mo12544r()     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            java.lang.String r4 = "Data loss, local db full"
            r15.mo12476a(r4)     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            long r13 = r13 - r11
            r11 = 1
            long r13 = r13 + r11
            ...
            com.google.android.gms.measurement.internal.l5 r4 = r1.f10651a     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            com.google.android.gms.measurement.internal.z3 r4 = r4.mo11935b()     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            com.google.android.gms.measurement.internal.x3 r4 = r4.mo12544r()     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            ...
            r4.mo12479d(r15, r2, r7, r11)     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
        L_0x009f:
        ...
        L_0x00cf:
            com.google.android.gms.measurement.internal.l5 r2 = r1.f10651a     // Catch:{ all -> 0x011f }
            com.google.android.gms.measurement.internal.z3 r2 = r2.mo11935b()     // Catch:{ all -> 0x011f }
            com.google.android.gms.measurement.internal.x3 r2 = r2.mo12544r()     // Catch:{ all -> 0x011f }
            java.lang.String r4 = "Error writing entry to local database"
            r2.mo12477b(r4, r0)     // Catch:{ all -> 0x011f }
            r2 = 1
            r1.f11263d = r2     // Catch:{ all -> 0x011f }
        ...
        L_0x012d:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C4038s3.m15314x(int, byte[]):boolean");
    }
    ...
    /* renamed from: o */
    public final SQLiteDatabase mo12405o() {
        if (this.f11263d) {
            return null;
        }
        SQLiteDatabase writableDatabase = this.f11262c.getWritableDatabase();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:47:?, code lost:
        r1.f10651a.mo11935b().mo12544r().mo12476a("Failed to load event from local database");
     */
    /* JADX WARNING: Code restructure failed: missing block: B:49:?, code lost:
        r12.recycle();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:60:?, code lost:
        r1.f10651a.mo11935b().mo12544r().mo12476a("Failed to load user property from local database");
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:75:?, code lost:
        r1.f10651a.mo11935b().mo12544r().mo12476a("Failed to load conditional user property from local database");
     */
    ...
    /* renamed from: p */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final java.util.List mo12406p(int r23) {
        /*
            r22 = this;
            r1 = r22
        ...
        L_0x001e:
            ...
            r10 = 1
            android.database.sqlite.SQLiteDatabase r15 = r22.mo12405o()     // Catch:{ SQLiteFullException -> 0x0224, SQLiteDatabaseLockedException -> 0x0211, SQLiteException -> 0x01ec, all -> 0x01e9 }
            if (r15 != 0) goto L_0x002a
            r1.f11263d = r10     // Catch:{ SQLiteFullException -> 0x01e4, SQLiteDatabaseLockedException -> 0x01e0, SQLiteException -> 0x01db, all -> 0x01d6 }
            return r4
        L_0x002a:
        ...
        L_0x008f:
            ...
            android.os.Parcelable$Creator<com.google.android.gms.measurement.internal.x> r0 = com.google.android.gms.measurement.internal.C4094x.CREATOR     // Catch:{ a -> 0x00c2 }
            java.lang.Object r0 = r0.createFromParcel(r12)     // Catch:{ a -> 0x00c2 }
            com.google.android.gms.measurement.internal.x r0 = (com.google.android.gms.measurement.internal.C4094x) r0     // Catch:{ a -> 0x00c2 }
        ...
        L_0x00c0:
            ...
            goto L_0x00d5
        L_0x00c2:
            com.google.android.gms.measurement.internal.l5 r0 = r1.f10651a     // Catch:{ all -> 0x00c0 }
            com.google.android.gms.measurement.internal.z3 r0 = r0.mo11935b()     // Catch:{ all -> 0x00c0 }
            com.google.android.gms.measurement.internal.x3 r0 = r0.mo12544r()     // Catch:{ all -> 0x00c0 }
            java.lang.String r13 = "Failed to load event from local database"
            r0.mo12476a(r13)     // Catch:{ all -> 0x00c0 }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01ac, SQLiteDatabaseLockedException -> 0x01a9, SQLiteException -> 0x01a5, all -> 0x01a0 }
            goto L_0x008f
        L_0x00d5:
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01ac, SQLiteDatabaseLockedException -> 0x01a9, SQLiteException -> 0x01a5, all -> 0x01a0 }
        ...
        L_0x00d9:
            ...
            android.os.Parcelable$Creator<com.google.android.gms.measurement.internal.sa> r0 = com.google.android.gms.measurement.internal.C4045sa.CREATOR     // Catch:{ a -> 0x00f4 }
            java.lang.Object r0 = r0.createFromParcel(r12)     // Catch:{ a -> 0x00f4 }
            com.google.android.gms.measurement.internal.sa r0 = (com.google.android.gms.measurement.internal.C4045sa) r0     // Catch:{ a -> 0x00f4 }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01ac, SQLiteDatabaseLockedException -> 0x01a9, SQLiteException -> 0x01a5, all -> 0x01a0 }
            goto L_0x0107
        L_0x00f2:
            r0 = move-exception
            goto L_0x010a
        L_0x00f4:
            com.google.android.gms.measurement.internal.l5 r0 = r1.f10651a     // Catch:{ all -> 0x00f2 }
            com.google.android.gms.measurement.internal.z3 r0 = r0.mo11935b()     // Catch:{ all -> 0x00f2 }
            com.google.android.gms.measurement.internal.x3 r0 = r0.mo12544r()     // Catch:{ all -> 0x00f2 }
            java.lang.String r13 = "Failed to load user property from local database"
            r0.mo12476a(r13)     // Catch:{ all -> 0x00f2 }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01ac, SQLiteDatabaseLockedException -> 0x01a9, SQLiteException -> 0x01a5, all -> 0x01a0 }
            r0 = r4
        L_0x0107:
            if (r0 == 0) goto L_0x008f
        ...
        L_0x010e:
            ...
            android.os.Parcel r12 = android.os.Parcel.obtain()     // Catch:{ SQLiteFullException -> 0x01ac, SQLiteDatabaseLockedException -> 0x01a9, SQLiteException -> 0x01a5, all -> 0x01a0 }
            int r0 = r13.length     // Catch:{ a -> 0x0129 }
            r12.unmarshall(r13, r7, r0)     // Catch:{ a -> 0x0129 }
            r12.setDataPosition(r7)     // Catch:{ a -> 0x0129 }
            android.os.Parcelable$Creator<com.google.android.gms.measurement.internal.d> r0 = com.google.android.gms.measurement.internal.C3845d.CREATOR     // Catch:{ a -> 0x0129 }
            java.lang.Object r0 = r0.createFromParcel(r12)     // Catch:{ a -> 0x0129 }
            com.google.android.gms.measurement.internal.d r0 = (com.google.android.gms.measurement.internal.C3845d) r0     // Catch:{ a -> 0x0129 }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01ac, SQLiteDatabaseLockedException -> 0x01a9, SQLiteException -> 0x01a5, all -> 0x01a0 }
            goto L_0x013c
        L_0x0127:
            r0 = move-exception
            goto L_0x0140
        L_0x0129:
            com.google.android.gms.measurement.internal.l5 r0 = r1.f10651a     // Catch:{ all -> 0x0127 }
            com.google.android.gms.measurement.internal.z3 r0 = r0.mo11935b()     // Catch:{ all -> 0x0127 }
            com.google.android.gms.measurement.internal.x3 r0 = r0.mo12544r()     // Catch:{ all -> 0x0127 }
            java.lang.String r13 = "Failed to load conditional user property from local database"
            r0.mo12476a(r13)     // Catch:{ all -> 0x0127 }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01ac, SQLiteDatabaseLockedException -> 0x01a9, SQLiteException -> 0x01a5, all -> 0x01a0 }
            r0 = r4
        L_0x013c:
            if (r0 == 0) goto L_0x008f
        ...
        L_0x0144:
            ...
            com.google.android.gms.measurement.internal.l5 r0 = r1.f10651a     // Catch:{ SQLiteFullException -> 0x01ac, SQLiteDatabaseLockedException -> 0x01a9, SQLiteException -> 0x01a5, all -> 0x01a0 }
            com.google.android.gms.measurement.internal.z3 r0 = r0.mo11935b()     // Catch:{ SQLiteFullException -> 0x01ac, SQLiteDatabaseLockedException -> 0x01a9, SQLiteException -> 0x01a5, all -> 0x01a0 }
            com.google.android.gms.measurement.internal.x3 r0 = r0.mo12549w()     // Catch:{ SQLiteFullException -> 0x01ac, SQLiteDatabaseLockedException -> 0x01a9, SQLiteException -> 0x01a5, all -> 0x01a0 }
            java.lang.String r12 = "Skipping app launch break"
        L_0x0153:
            r0.mo12476a(r12)     // Catch:{ SQLiteFullException -> 0x01ac, SQLiteDatabaseLockedException -> 0x01a9, SQLiteException -> 0x01a5, all -> 0x01a0 }
            goto L_0x008f
        L_0x0158:
            com.google.android.gms.measurement.internal.l5 r0 = r1.f10651a     // Catch:{ SQLiteFullException -> 0x01ac, SQLiteDatabaseLockedException -> 0x01a9, SQLiteException -> 0x01a5, all -> 0x01a0 }
            com.google.android.gms.measurement.internal.z3 r0 = r0.mo11935b()     // Catch:{ SQLiteFullException -> 0x01ac, SQLiteDatabaseLockedException -> 0x01a9, SQLiteException -> 0x01a5, all -> 0x01a0 }
            com.google.android.gms.measurement.internal.x3 r0 = r0.mo12544r()     // Catch:{ SQLiteFullException -> 0x01ac, SQLiteDatabaseLockedException -> 0x01a9, SQLiteException -> 0x01a5, all -> 0x01a0 }
        ...
        L_0x0165:
            ...
            com.google.android.gms.measurement.internal.l5 r0 = r1.f10651a     // Catch:{ SQLiteFullException -> 0x019d, SQLiteDatabaseLockedException -> 0x01e2, SQLiteException -> 0x019b, all -> 0x0199 }
            com.google.android.gms.measurement.internal.z3 r0 = r0.mo11935b()     // Catch:{ SQLiteFullException -> 0x019d, SQLiteDatabaseLockedException -> 0x01e2, SQLiteException -> 0x019b, all -> 0x0199 }
            com.google.android.gms.measurement.internal.x3 r0 = r0.mo12544r()     // Catch:{ SQLiteFullException -> 0x019d, SQLiteDatabaseLockedException -> 0x01e2, SQLiteException -> 0x019b, all -> 0x0199 }
            java.lang.String r12 = "Fewer entries removed from local database than expected"
            r0.mo12476a(r12)     // Catch:{ SQLiteFullException -> 0x019d, SQLiteDatabaseLockedException -> 0x01e2, SQLiteException -> 0x019b, all -> 0x0199 }
        L_0x018c:
        ...
        L_0x01fa:
            com.google.android.gms.measurement.internal.l5 r12 = r1.f10651a     // Catch:{ all -> 0x0242 }
            com.google.android.gms.measurement.internal.z3 r12 = r12.mo11935b()     // Catch:{ all -> 0x0242 }
            com.google.android.gms.measurement.internal.x3 r12 = r12.mo12544r()     // Catch:{ all -> 0x0242 }
            r12.mo12477b(r3, r0)     // Catch:{ all -> 0x0242 }
            r1.f11263d = r10     // Catch:{ all -> 0x0242 }
        ...
        L_0x025f:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C4038s3.mo12406p(int):java.util.List");
    }

    /* renamed from: q */
    public final void mo12407q() {
        int delete;
        mo11931h();
        try {
            SQLiteDatabase o = mo12405o();
            if (o != null && (delete = o.delete("messages", (String) null, (String[]) null)) > 0) {
                this.f10651a.mo11935b().mo12548v().mo12477b("Reset local analytics data. records", Integer.valueOf(delete));
            }
        } catch (SQLiteException e) {
            this.f10651a.mo11935b().mo12544r().mo12477b("Error resetting local analytics data. error", e);
        }
    }

    /* renamed from: r */
    public final boolean mo12408r() {
        return m15314x(3, new byte[0]);
    }

    /* access modifiers changed from: package-private */
    /* renamed from: s */
    public final boolean mo12409s() {
        Context f = this.f10651a.mo11938f();
        this.f10651a.mo12181z();
    ...
    /* renamed from: t */
    public final boolean mo12410t() {
        mo11931h();
        if (!this.f11263d && mo12409s()) {
            int i = 0;
            int i2 = 5;
            while (i < 5) {
                ...
                try {
                    ...
                    this.f10651a.mo11935b().mo12544r().mo12477b("Error deleting app launch break from local database", e);
                    this.f11263d = true;
                    ...
                    this.f10651a.mo11935b().mo12544r().mo12477b("Error deleting app launch break from local database", e2);
                    this.f11263d = true;
                    if (sQLiteDatabase != null) {
                        sQLiteDatabase.close();
                        i++;
            ...
            this.f10651a.mo11935b().mo12549w().mo12476a("Error deleting app launch break from local database in reasonable time");
        }
        return false;
    }

    /* renamed from: u */
    public final boolean mo12411u(C3845d dVar) {
        byte[] c0 = this.f10651a.mo12161N().mo12507c0(dVar);
        if (c0.length <= 131072) {
            return m15314x(2, c0);
        }
        this.f10651a.mo11935b().mo12546t().mo12476a("Conditional user property too long for local database. Sending directly to service");
        return false;
    }

    /* renamed from: v */
    public final boolean mo12412v(C4094x xVar) {
        Parcel obtain = Parcel.obtain();
        C4106y.m15457a(xVar, obtain, 0);
        byte[] marshall = obtain.marshall();
        obtain.recycle();
        if (marshall.length <= 131072) {
            return m15314x(0, marshall);
        }
        this.f10651a.mo11935b().mo12546t().mo12476a("Event is too long for local database. Sending event directly to service");
        return false;
    }

    /* renamed from: w */
    public final boolean mo12413w(C4045sa saVar) {
        Parcel obtain = Parcel.obtain();
        C4057ta.m15346a(saVar, obtain, 0);
        byte[] marshall = obtain.marshall();
        obtain.recycle();
        if (marshall.length <= 131072) {
            return m15314x(1, marshall);
        }
        this.f10651a.mo11935b().mo12546t().mo12476a("User property too long for local database. Sending directly to service");
        return false;
    }
}
