...
public final class CipherSuite {
    ...
    public static final class Companion {
        ...
        public final CipherSuite init(String str, int i) {
            CipherSuite cipherSuite = new CipherSuite(str, (C10452g) null);
            CipherSuite.INSTANCES.put(str, cipherSuite);
            return cipherSuite;
        }

        private final String secondaryName(String str) {
            if (C10299p.m34926B(str, "TLS_", false, 2, (Object) null)) {
                ...
                sb.append(substring);
                return sb.toString();
            } else if (!C10299p.m34926B(str, "SSL_", false, 2, (Object) null)) {
                return str;
            } else {
    ...
    public /* synthetic */ CipherSuite(String str, C10452g gVar) {
        this(str);
    }
    ...
    public final String m37355deprecated_javaName() {
