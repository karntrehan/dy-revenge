...
public final class Http2Connection$pushDataLater$$inlined$execute$1 extends Task {
    final /* synthetic */ C10603f $buffer$inlined;
    ...
    public Http2Connection$pushDataLater$$inlined$execute$1(String str, boolean z, String str2, boolean z2, Http2Connection http2Connection, int i, C10603f fVar, int i2, boolean z3) {
        super(str2, z2);
        this.$name = str;
        this.$cancelable = z;
    ...
    public long runOnce() {
        /*
            ...
            i.f r2 = r5.$buffer$inlined     // Catch:{ IOException -> 0x003e }
