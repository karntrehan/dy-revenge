...
/* renamed from: c.w.a.a.c */
public class C2233c {
    /* renamed from: a */
    private static Interpolator m9425a(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser) {
        Interpolator fVar;
                ...
                if (next == 2) {
                    ...
                    if (name.equals("linearInterpolator")) {
                        ...
                        if (name.equals("accelerateInterpolator")) {
                            ...
                            fVar = new C2237f(context, asAttributeSet, xmlPullParser);
                        } else {
    ...
    /* renamed from: b */
    public static Interpolator m9426b(Context context, int i) {
        ...
        if (i == 17563663) {
            ...
            Interpolator a = m9425a(context, context.getResources(), context.getTheme(), animation);
            if (animation != null) {
                animation.close();
            }
            return a;
