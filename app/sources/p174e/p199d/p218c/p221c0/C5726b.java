...
/* renamed from: e.d.c.c0.b */
public class C5726b extends C5722b {

    /* renamed from: f */
    protected static final HashMap<Integer, String> f16195f;

    /* renamed from: g */
    protected static final transient HashMap<String, Integer> f16196g;

    /* renamed from: h */
    protected static final transient HashMap<Integer, String> f16197h;
    ...
    static {
        ...
        hashMap3.put(Integer.valueOf(C1444j.f4216D0), "Voxware AC16");
        hashMap3.put(Integer.valueOf(C1444j.f4221E0), "Voxware AC20");
        hashMap3.put(Integer.valueOf(C1444j.f4226F0), "Voxware MetaVoice");
        hashMap3.put(Integer.valueOf(C1444j.f4231G0), "Voxware MetaSound");
        hashMap3.put(Integer.valueOf(C1444j.f4236H0), "Voxware RT29HW");
        hashMap3.put(Integer.valueOf(C1444j.f4241I0), "Voxware VR12");
        hashMap3.put(Integer.valueOf(C1444j.f4246J0), "Voxware VR18");
        hashMap3.put(Integer.valueOf(C1444j.f4251K0), "Voxware TQ40");
        hashMap3.put(Integer.valueOf(C1444j.f4256L0), "Voxware SC3");
        hashMap3.put(Integer.valueOf(C1444j.f4261M0), "Voxware SC3");
