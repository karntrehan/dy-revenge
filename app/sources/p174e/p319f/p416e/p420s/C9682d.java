...
public enum C9682d {
    ...
    /* renamed from: O */
    private static final Map<Integer, C9682d> f25915O = null;

    /* renamed from: P */
    private static final Map<String, C9682d> f25916P = null;

    /* renamed from: R */
    private final int[] f25931R;

    /* renamed from: S */
    private final String[] f25932S;

    static {
        f25915O = new HashMap();
        f25916P = new HashMap();
        for (C9682d dVar : values()) {
            for (int valueOf : dVar.f25931R) {
                f25915O.put(Integer.valueOf(valueOf), dVar);
            }
            f25916P.put(dVar.name(), dVar);
            for (String put : dVar.f25932S) {
                f25916P.put(put, dVar);
            }
        }
    }

    private C9682d(int i) {
        this(r3, r4, new int[]{i}, new String[0]);
    }

    private C9682d(int i, String... strArr) {
        this.f25931R = new int[]{i};
        this.f25932S = strArr;
    }

    private C9682d(int[] iArr, String... strArr) {
        this.f25931R = iArr;
        this.f25932S = strArr;
    }

    /* renamed from: e */
    public static C9682d m32941e(int i) {
        if (i >= 0 && i < 900) {
            return f25915O.get(Integer.valueOf(i));
        }
