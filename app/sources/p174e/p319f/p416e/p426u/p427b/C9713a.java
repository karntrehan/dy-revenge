...
final class C9713a {
    ...
    /* renamed from: a */
    public byte[] mo24347a() {
        byte[] bArr = new byte[144];
        int j = this.f26028b.mo24268j();
        int m = this.f26028b.mo24271m();
        for (int i = 0; i < j; i++) {
            int[] iArr = f26027a[i];
            for (int i2 = 0; i2 < m; i2++) {
                int i3 = iArr[i2];
                if (i3 >= 0 && this.f26028b.mo24264f(i2, i)) {
                    int i4 = i3 / 6;
