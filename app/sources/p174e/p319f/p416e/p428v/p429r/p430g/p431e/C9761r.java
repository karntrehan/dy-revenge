...
final class C9761r {
    ...
    /* renamed from: b */
    private static String m33264b(int i, int i2, String str) {
        if (str.length() >= i) {
            ...
            if (str.length() >= i3) {
                ...
                String a = m33263a(str.substring(i3));
                if (a == null) {
                    return str2;
                }
                return str2 + a;
    ...
    /* renamed from: c */
    private static String m33265c(int i, int i2, String str) {
        String substring = str.substring(0, i);
        int i3 = i2 + i;
        if (str.length() < i3) {
            i3 = str.length();
