...
/* renamed from: e.f.c.a.y.q */
public final class C9396q extends C9577z<C9396q, C9398b> implements C9546t0 {
    /* access modifiers changed from: private */
    public static final C9396q DEFAULT_INSTANCE;
    public static final int KEY_SIZE_FIELD_NUMBER = 1;
    private static volatile C9429a1<C9396q> PARSER;
    private int keySize_;

    /* renamed from: e.f.c.a.y.q$a */
    static /* synthetic */ class C9397a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f25267a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f25267a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f25267a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f25267a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f25267a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f25267a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p174e.p319f.p393c.p394a.p403y.C9396q.C9397a.<clinit>():void");
        }
    }

    /* renamed from: e.f.c.a.y.q$b */
    public static final class C9398b extends C9577z.C9578a<C9396q, C9398b> implements C9546t0 {
        private C9398b() {
            super(C9396q.DEFAULT_INSTANCE);
        }

        /* synthetic */ C9398b(C9397a aVar) {
            this();
        }

        /* renamed from: z */
        public C9398b mo23449z(int i) {
            mo24067t();
            ((C9396q) this.f25644o).m31305R(i);
            return this;
        }
    }

    static {
        C9396q qVar = new C9396q();
        DEFAULT_INSTANCE = qVar;
        C9577z.m32635K(C9396q.class, qVar);
    }
    ...
    /* renamed from: P */
    public static C9398b m31303P() {
        return (C9398b) DEFAULT_INSTANCE.mo24058r();
    }

    /* renamed from: Q */
    public static C9396q m31304Q(C9468i iVar, C9526q qVar) {
        return (C9396q) C9577z.m32630F(DEFAULT_INSTANCE, iVar, qVar);
    }

    /* access modifiers changed from: private */
    /* renamed from: R */
    public void m31305R(int i) {
        this.keySize_ = i;
    }
    ...
    public final Object mo23350u(C9577z.C9583f fVar, Object obj, Object obj2) {
        switch (C9397a.f25267a[fVar.ordinal()]) {
            case 1:
                return new C9396q();
            case 2:
                return new C9398b((C9397a) null);
            case 3:
                return C9577z.m32629D(DEFAULT_INSTANCE, "\u0000\u0001\u0000\u0000\u0001\u0001\u0001\u0000\u0000\u0000\u0001\u000b", new Object[]{"keySize_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                C9429a1<C9396q> a1Var = PARSER;
                if (a1Var == null) {
                    synchronized (C9396q.class) {
                        a1Var = PARSER;
                        if (a1Var == null) {
