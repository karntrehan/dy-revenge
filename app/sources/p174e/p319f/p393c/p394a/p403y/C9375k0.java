...
/* renamed from: e.f.c.a.y.k0 */
public final class C9375k0 extends C9577z<C9375k0, C9377b> implements C9546t0 {
    /* access modifiers changed from: private */
    public static final C9375k0 DEFAULT_INSTANCE;
    public static final int KEY_VALUE_FIELD_NUMBER = 3;
    private static volatile C9429a1<C9375k0> PARSER = null;
    public static final int VERSION_FIELD_NUMBER = 1;
    private C9468i keyValue_ = C9468i.f25367f;
    private int version_;

    /* renamed from: e.f.c.a.y.k0$a */
    static /* synthetic */ class C9376a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f25260a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f25260a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f25260a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f25260a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f25260a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f25260a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p174e.p319f.p393c.p394a.p403y.C9375k0.C9376a.<clinit>():void");
        }
    }

    /* renamed from: e.f.c.a.y.k0$b */
    public static final class C9377b extends C9577z.C9578a<C9375k0, C9377b> implements C9546t0 {
        private C9377b() {
            super(C9375k0.DEFAULT_INSTANCE);
        }

        /* synthetic */ C9377b(C9376a aVar) {
            this();
        }

        /* renamed from: B */
        public C9377b mo23431B(int i) {
            mo24067t();
            ((C9375k0) this.f25644o).m31244U(i);
            return this;
        }

        /* renamed from: z */
        public C9377b mo23432z(C9468i iVar) {
            mo24067t();
            ((C9375k0) this.f25644o).m31243T(iVar);
            return this;
        }
    }

    static {
        C9375k0 k0Var = new C9375k0();
        DEFAULT_INSTANCE = k0Var;
        C9577z.m32635K(C9375k0.class, k0Var);
    }
    ...
    /* renamed from: R */
    public static C9377b m31241R() {
        return (C9377b) DEFAULT_INSTANCE.mo24058r();
    }

    /* renamed from: S */
    public static C9375k0 m31242S(C9468i iVar, C9526q qVar) {
        return (C9375k0) C9577z.m32630F(DEFAULT_INSTANCE, iVar, qVar);
    }

    /* access modifiers changed from: private */
    /* renamed from: T */
    public void m31243T(C9468i iVar) {
        iVar.getClass();
        this.keyValue_ = iVar;
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: U */
    public void m31244U(int i) {
        this.version_ = i;
    }

    /* renamed from: P */
    public C9468i mo23429P() {
    ...
    public final Object mo23350u(C9577z.C9583f fVar, Object obj, Object obj2) {
        switch (C9376a.f25260a[fVar.ordinal()]) {
            case 1:
                return new C9375k0();
            case 2:
                return new C9377b((C9376a) null);
            case 3:
                return C9577z.m32629D(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0003\u0002\u0000\u0000\u0000\u0001\u000b\u0003\n", new Object[]{"version_", "keyValue_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                C9429a1<C9375k0> a1Var = PARSER;
                if (a1Var == null) {
                    synchronized (C9375k0.class) {
                        a1Var = PARSER;
                        if (a1Var == null) {
