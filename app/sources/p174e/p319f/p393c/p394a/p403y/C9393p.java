...
/* renamed from: e.f.c.a.y.p */
public final class C9393p extends C9577z<C9393p, C9395b> implements C9546t0 {
    /* access modifiers changed from: private */
    public static final C9393p DEFAULT_INSTANCE;
    public static final int KEY_VALUE_FIELD_NUMBER = 2;
    private static volatile C9429a1<C9393p> PARSER = null;
    public static final int VERSION_FIELD_NUMBER = 1;
    private C9468i keyValue_ = C9468i.f25367f;
    private int version_;

    /* renamed from: e.f.c.a.y.p$a */
    static /* synthetic */ class C9394a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f25266a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f25266a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f25266a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f25266a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f25266a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f25266a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p174e.p319f.p393c.p394a.p403y.C9393p.C9394a.<clinit>():void");
        }
    }

    /* renamed from: e.f.c.a.y.p$b */
    public static final class C9395b extends C9577z.C9578a<C9393p, C9395b> implements C9546t0 {
        private C9395b() {
            super(C9393p.DEFAULT_INSTANCE);
        }

        /* synthetic */ C9395b(C9394a aVar) {
            this();
        }

        /* renamed from: B */
        public C9395b mo23446B(int i) {
            mo24067t();
            ((C9393p) this.f25644o).m31295U(i);
            return this;
        }

        /* renamed from: z */
        public C9395b mo23447z(C9468i iVar) {
            mo24067t();
            ((C9393p) this.f25644o).m31294T(iVar);
            return this;
        }
    }

    static {
        C9393p pVar = new C9393p();
        DEFAULT_INSTANCE = pVar;
        C9577z.m32635K(C9393p.class, pVar);
    }
    ...
    /* renamed from: R */
    public static C9395b m31292R() {
        return (C9395b) DEFAULT_INSTANCE.mo24058r();
    }

    /* renamed from: S */
    public static C9393p m31293S(C9468i iVar, C9526q qVar) {
        return (C9393p) C9577z.m32630F(DEFAULT_INSTANCE, iVar, qVar);
    }

    /* access modifiers changed from: private */
    /* renamed from: T */
    public void m31294T(C9468i iVar) {
        iVar.getClass();
        this.keyValue_ = iVar;
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: U */
    public void m31295U(int i) {
        this.version_ = i;
    }

    /* renamed from: P */
    public C9468i mo23444P() {
    ...
    public final Object mo23350u(C9577z.C9583f fVar, Object obj, Object obj2) {
        switch (C9394a.f25266a[fVar.ordinal()]) {
            case 1:
                return new C9393p();
            case 2:
                return new C9395b((C9394a) null);
            case 3:
                return C9577z.m32629D(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0000\u0000\u0000\u0001\u000b\u0002\n", new Object[]{"version_", "keyValue_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                C9429a1<C9393p> a1Var = PARSER;
                if (a1Var == null) {
                    synchronized (C9393p.class) {
                        a1Var = PARSER;
                        if (a1Var == null) {
