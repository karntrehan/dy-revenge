...
/* renamed from: e.f.c.a.y.f0 */
public final class C9346f0 extends C9577z<C9346f0, C9348b> implements C9546t0 {
    /* access modifiers changed from: private */
    public static final C9346f0 DEFAULT_INSTANCE;
    public static final int KEY_URI_FIELD_NUMBER = 1;
    private static volatile C9429a1<C9346f0> PARSER;
    private String keyUri_ = HttpUrl.FRAGMENT_ENCODE_SET;

    /* renamed from: e.f.c.a.y.f0$a */
    static /* synthetic */ class C9347a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f25242a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f25242a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f25242a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f25242a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f25242a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f25242a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p174e.p319f.p393c.p394a.p403y.C9346f0.C9347a.<clinit>():void");
        }
    }

    /* renamed from: e.f.c.a.y.f0$b */
    public static final class C9348b extends C9577z.C9578a<C9346f0, C9348b> implements C9546t0 {
        private C9348b() {
            super(C9346f0.DEFAULT_INSTANCE);
        }

        /* synthetic */ C9348b(C9347a aVar) {
            this();
        }
    }

    static {
        C9346f0 f0Var = new C9346f0();
        DEFAULT_INSTANCE = f0Var;
        C9577z.m32635K(C9346f0.class, f0Var);
    }
    ...
    /* renamed from: N */
    public static C9346f0 m31174N() {
        return DEFAULT_INSTANCE;
    }

    /* renamed from: P */
    public static C9346f0 m31175P(C9468i iVar, C9526q qVar) {
        return (C9346f0) C9577z.m32630F(DEFAULT_INSTANCE, iVar, qVar);
    }

    /* renamed from: O */
    public String mo23407O() {
        return this.keyUri_;
    }
    ...
    public final Object mo23350u(C9577z.C9583f fVar, Object obj, Object obj2) {
        switch (C9347a.f25242a[fVar.ordinal()]) {
            case 1:
                return new C9346f0();
            case 2:
                return new C9348b((C9347a) null);
            case 3:
                return C9577z.m32629D(DEFAULT_INSTANCE, "\u0000\u0001\u0000\u0000\u0001\u0001\u0001\u0000\u0000\u0000\u0001Ȉ", new Object[]{"keyUri_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                C9429a1<C9346f0> a1Var = PARSER;
                if (a1Var == null) {
                    synchronized (C9346f0.class) {
                        a1Var = PARSER;
                        if (a1Var == null) {
