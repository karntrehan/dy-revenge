...
/* renamed from: e.f.c.a.y.n */
public final class C9387n extends C9577z<C9387n, C9389b> implements C9546t0 {
    /* access modifiers changed from: private */
    public static final C9387n DEFAULT_INSTANCE;
    public static final int KEY_VALUE_FIELD_NUMBER = 3;
    private static volatile C9429a1<C9387n> PARSER = null;
    public static final int VERSION_FIELD_NUMBER = 1;
    private C9468i keyValue_ = C9468i.f25367f;
    private int version_;

    /* renamed from: e.f.c.a.y.n$a */
    static /* synthetic */ class C9388a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f25264a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f25264a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f25264a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f25264a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f25264a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f25264a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p174e.p319f.p393c.p394a.p403y.C9387n.C9388a.<clinit>():void");
        }
    }

    /* renamed from: e.f.c.a.y.n$b */
    public static final class C9389b extends C9577z.C9578a<C9387n, C9389b> implements C9546t0 {
        private C9389b() {
            super(C9387n.DEFAULT_INSTANCE);
        }

        /* synthetic */ C9389b(C9388a aVar) {
            this();
        }

        /* renamed from: B */
        public C9389b mo23441B(int i) {
            mo24067t();
            ((C9387n) this.f25644o).m31279U(i);
            return this;
        }

        /* renamed from: z */
        public C9389b mo23442z(C9468i iVar) {
            mo24067t();
            ((C9387n) this.f25644o).m31278T(iVar);
            return this;
        }
    }

    static {
        C9387n nVar = new C9387n();
        DEFAULT_INSTANCE = nVar;
        C9577z.m32635K(C9387n.class, nVar);
    }
    ...
    /* renamed from: R */
    public static C9389b m31276R() {
        return (C9389b) DEFAULT_INSTANCE.mo24058r();
    }

    /* renamed from: S */
    public static C9387n m31277S(C9468i iVar, C9526q qVar) {
        return (C9387n) C9577z.m32630F(DEFAULT_INSTANCE, iVar, qVar);
    }

    /* access modifiers changed from: private */
    /* renamed from: T */
    public void m31278T(C9468i iVar) {
        iVar.getClass();
        this.keyValue_ = iVar;
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: U */
    public void m31279U(int i) {
        this.version_ = i;
    }

    /* renamed from: P */
    public C9468i mo23439P() {
    ...
    public final Object mo23350u(C9577z.C9583f fVar, Object obj, Object obj2) {
        switch (C9388a.f25264a[fVar.ordinal()]) {
            case 1:
                return new C9387n();
            case 2:
                return new C9389b((C9388a) null);
            case 3:
                return C9577z.m32629D(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0003\u0002\u0000\u0000\u0000\u0001\u000b\u0003\n", new Object[]{"version_", "keyValue_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                C9429a1<C9387n> a1Var = PARSER;
                if (a1Var == null) {
                    synchronized (C9387n.class) {
                        a1Var = PARSER;
                        if (a1Var == null) {
