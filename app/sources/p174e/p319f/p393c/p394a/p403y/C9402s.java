...
/* renamed from: e.f.c.a.y.s */
public final class C9402s extends C9577z<C9402s, C9404b> implements C9546t0 {
    /* access modifiers changed from: private */
    public static final C9402s DEFAULT_INSTANCE;
    private static volatile C9429a1<C9402s> PARSER;

    /* renamed from: e.f.c.a.y.s$a */
    static /* synthetic */ class C9403a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f25269a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f25269a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f25269a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f25269a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f25269a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f25269a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p174e.p319f.p393c.p394a.p403y.C9402s.C9403a.<clinit>():void");
        }
    }

    /* renamed from: e.f.c.a.y.s$b */
    public static final class C9404b extends C9577z.C9578a<C9402s, C9404b> implements C9546t0 {
        private C9404b() {
            super(C9402s.DEFAULT_INSTANCE);
        }

        /* synthetic */ C9404b(C9403a aVar) {
            this();
        }
    }

    static {
        C9402s sVar = new C9402s();
        DEFAULT_INSTANCE = sVar;
        C9577z.m32635K(C9402s.class, sVar);
    }
    ...
    /* renamed from: N */
    public static C9402s m31322N(C9468i iVar, C9526q qVar) {
        return (C9402s) C9577z.m32630F(DEFAULT_INSTANCE, iVar, qVar);
    }

    /* access modifiers changed from: protected */
    /* renamed from: u */
    public final Object mo23350u(C9577z.C9583f fVar, Object obj, Object obj2) {
        switch (C9403a.f25269a[fVar.ordinal()]) {
            case 1:
                return new C9402s();
            case 2:
                return new C9404b((C9403a) null);
            case 3:
                return C9577z.m32629D(DEFAULT_INSTANCE, "\u0000\u0000", (Object[]) null);
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                C9429a1<C9402s> a1Var = PARSER;
                if (a1Var == null) {
                    synchronized (C9402s.class) {
                        a1Var = PARSER;
                        if (a1Var == null) {
