...
/* renamed from: e.f.c.a.y.g */
public final class C9349g extends C9577z<C9349g, C9351b> implements C9546t0 {
    /* access modifiers changed from: private */
    public static final C9349g DEFAULT_INSTANCE;
    public static final int KEY_SIZE_FIELD_NUMBER = 2;
    public static final int PARAMS_FIELD_NUMBER = 1;
    private static volatile C9429a1<C9349g> PARSER;
    private int keySize_;
    private C9355h params_;

    /* renamed from: e.f.c.a.y.g$a */
    static /* synthetic */ class C9350a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f25243a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f25243a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f25243a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f25243a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f25243a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f25243a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p174e.p319f.p393c.p394a.p403y.C9349g.C9350a.<clinit>():void");
        }
    }

    /* renamed from: e.f.c.a.y.g$b */
    public static final class C9351b extends C9577z.C9578a<C9349g, C9351b> implements C9546t0 {
        private C9351b() {
            super(C9349g.DEFAULT_INSTANCE);
        }

        /* synthetic */ C9351b(C9350a aVar) {
            this();
        }
    }

    static {
        C9349g gVar = new C9349g();
        DEFAULT_INSTANCE = gVar;
        C9577z.m32635K(C9349g.class, gVar);
    }
    ...
    /* renamed from: N */
    public static C9349g m31179N() {
        return DEFAULT_INSTANCE;
    }

    /* renamed from: Q */
    public static C9349g m31180Q(C9468i iVar, C9526q qVar) {
        return (C9349g) C9577z.m32630F(DEFAULT_INSTANCE, iVar, qVar);
    }
    ...
    public final Object mo23350u(C9577z.C9583f fVar, Object obj, Object obj2) {
        switch (C9350a.f25243a[fVar.ordinal()]) {
            case 1:
                return new C9349g();
            case 2:
                return new C9351b((C9350a) null);
            case 3:
                return C9577z.m32629D(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0000\u0000\u0000\u0001\t\u0002\u000b", new Object[]{"params_", "keySize_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                C9429a1<C9349g> a1Var = PARSER;
                if (a1Var == null) {
                    synchronized (C9349g.class) {
                        a1Var = PARSER;
                        if (a1Var == null) {
